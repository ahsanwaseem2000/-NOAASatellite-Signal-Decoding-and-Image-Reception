...
Tools Used
RTL-SDR USB Dongle: Receives satellite signals for further processing.

V-Dipole Antenna: Used to capture the 137.62 MHz APT signals.

Cubic SDR: Software to interact with the RTL-SDR dongle for signal reception.

WXtoImg: Decodes the received APT signal into images of Earth’s surface.

GPredict: Software for satellite orbit prediction and tracking.
